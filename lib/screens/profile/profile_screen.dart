  ...
  Widget _buildProfileHeader(BuildContext context) {
    return Column(
      children: [
        ...
        Text(
          'Member sejak ${_user.memberSince}',
            ...
            children: [
              Expanded(
                child: _StatCard(
                  ...
                  value: '${_user.totalWasteKg.toStringAsFixed(0)} kg',
                  label: 'Limbah',
                ),
              ),
              ...
              Expanded(
                child: _StatCard(
                  ...
                  iconColor: AppColors.primaryLight,
                  value: '${_user.co2OffsetKg.toStringAsFixed(0)} kg',
                  label: 'Offset',
                  topLabel: 'CO₂',
                ),
              ),
